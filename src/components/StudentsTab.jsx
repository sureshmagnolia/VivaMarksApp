      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
        ...
        {students.length === 0 && (
          <div className="glass-panel" style={{ padding: '2.5rem', textAlign: 'center', color: '#cbd5e1', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1rem' }}>
            <User size={48} color="#60a5fa" style={{ opacity: 0.6 }} />
            <div>
            ...
            <button 
              ...
              style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '10px 20px', marginTop: '0.5rem' }}
            >
          ...
          <div key={student.id} className="glass-panel student-card animate-fade-in" style={{ padding: '1rem', background: 'rgba(30, 41, 59, 0.4)' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '0.75rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <span className="badge badge-primary" style={{ background: '#3b82f6', color: '#fff', padding: '2px 8px', borderRadius: '12px', fontSize: '0.8rem', fontWeight: 'bold' }}>
                  #{index + 1}
                </span>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '1rem' }}>
              ...
              <div>
                <label className="input-label" style={{ fontSize: '0.8rem', marginBottom: '4px', display: 'block', color: '#cbd5e1' }}>Project Topic</label>
                <input
                  type="text"
                  className="input-field"
        ...
        {students.length > 0 && (
          <button
            className="btn btn-primary"
            onClick={handleAddStudent}
            style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', padding: '12px', width: '100%', marginTop: '0.5rem' }}
          >
